...
function adminOk(req){const expected=process.env.ADMIN_PASSWORD?.trim();const provided=req.headers.get('x-admin-password')?.trim();return!!expected&&!!provided&&provided===expected;}
